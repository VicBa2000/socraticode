...
export namespace ShareNext {
  ...
  const disabled = process.env["SOCRATICODE_DISABLE_SHARE"] === "true" || process.env["SOCRATICODE_DISABLE_SHARE"] === "1"
  ...
  export class Service extends Context.Service<Service, Interface>()("@socraticode/ShareNext") {}
